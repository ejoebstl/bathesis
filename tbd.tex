...
\tikzstyle{memo}=[draw,fill=lightgreen,diamond,minimum size=8pt,inner sep=0pt,label={0:$memo$}]
\tikzstyle{write}=[draw,fill=orange,circle,minimum size=8pt,inner sep=0pt,label={0:$write$}]
\tikzstyle{par}=[draw,fill=yellow,diamond,minimum size=8pt,inner sep=0pt,label={0:$par$}]
...
\input{1_5_fundamentals.tex}
\input{2_tbd.tex}
\input{3_tbd_theory.tex}
\input{4_distance_algorithm.tex}
\input{5_optimizing_algorithms.tex}
\input{6_rw_examples.tex}
