...
\centering
\begin{tikzpicture}
\begin{axis}[xlabel=Start Index,ylabel=Update Lentgh]
\addplot3[surf]
table{data/simpleMap.txt};
\end{axis}
\end{tikzpicture}
\caption{Plot of the data found in table \ref{tbl:introducing_example}.}
\label{plot:introducing_example}
\end{figure}
...
-o NAME  & Sets the output format for the results: $visualizer$, $diff$, $latex$ or $exhaustive$\\ \hline
